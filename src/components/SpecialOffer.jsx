...
export default function SpecialOffer() {
  return (
    ...
    >
      ...
      <Image src="/assets/g1.svg" width={500} height={500} alt="Decoration 2" className="absolute  right-[100px] " />
      ...
      <div className=" p-10 px-12 mx-auto text-left">
      <span className='text-sm md:text-xl font-medium text-[#749B3F] bg-[#749B3F1A] py-1.5 px-3 rounded-md'>Special Offer</span>
      
          <h2 className="text-[80px] font-bold text-[#212337] ">Seasonal Fruit Bundle</h2>
          <p className="text-[48px] font-semibold text-[#212337] mb-4">Discount up to <span className='text-[#FF6A1A]'>80% OFF</span> </p>

          <div className="flex space-x-2 mb-4 ">
            <div className="flex flex-col items-center bg-white shadow rounded-md px-5 py-2">
              <span className="text-[40px] font-bold text-[#212337] ">03</span>
              <span className="text-lg text-[#4A4A52]">Days</span>
            </div>
            <div className="flex flex-col items-center bg-white shadow rounded-md px-5 py-2">
              <span className="text-[40px] font-bold text-[#212337] ">18</span>
              <span className="text-lg text-[#4A4A52]">Hour</span>
            </div>
            <div className="flex flex-col items-center bg-white shadow rounded-md px-5 py-2">
              <span className="text-[40px] font-bold text-[#212337] ">54</span>
              <span className="text-lg text-[#4A4A52]">Min</span>
            </div>
            <div className="flex flex-col items-center bg-white shadow rounded-md px-5 py-2">
              <span className="text-[40px] font-bold text-[#212337] ">21</span>
              <span className="text-lg text-[#4A4A52]">Second</span>
            </div>
          </div>

          <button className="bg-[#176D38]   text-[32px]  text-white py-4 px-6 rounded-full text-center font-semibold">
