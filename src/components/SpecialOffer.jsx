...
export default function SpecialOffer() {
  return (
    <div
      className="relative mx-auto  flex items-center justify-center w-full bg-cover bg-center"
      style={{
        height: "600px",
    ...
    >
      ...
      <div className="w-full mx-auto z-50 container">
        <div className="p-10 px-12 mx-auto text-center lg:text-left">
          ...
          <h2 className="text-[36px] sm:text-[48px] lg:text-[80px] font-bold text-[#212337]">
            Seasonal Fruit Bundle
          </h2>
          <p className="text-[24px] sm:text-[32px] lg:text-[48px] font-semibold text-[#212337] mb-4">
      ...
      <Image
        src="/assets/clip-path0group.png"
        width={700}
        height={700}
        alt="Main Visual"
        className="absolute bottom-0 left-0 w-full max-w-[700px]"
      />
    </div>
  );
}
